package surreal.test.entity.renderer;
...
public class RenderRubiksCube<T extends EntityRubiksCube> extends Render<T> {

    private ModelManager manager = null;

    public RenderRubiksCube(RenderManager renderManager) {
        super(renderManager);
    }
    ...
    public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        model = this.manager.getModel(Test.MODEL_RUBIKS_CUBE); // Get the model
